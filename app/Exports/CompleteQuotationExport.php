...
class CompleteQuotationExport implements FromView, ShouldAutoSize, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('users.exports.complete-quotation-exp', ['query' => $query,'not_visible_arr' => $not_visible_arr]);
    }
